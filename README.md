This project compare two algoritm to TSP problem, the first algorithm use dynamic programe to solve is an exact algorithm and the second use heuristc to solve, in this case use ant colony algorithm.
